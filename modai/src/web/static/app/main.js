...
const I18N = {
  en: {
    ...
    billingSetupPartial: 'needs quote',
    billingSetupOptional: 'optional',
    billingSetupBankPartialHint: 'Bank recipient details are ready. Add MODAI_BANK_USD_TO_TRY_RATE to quote TRY invoices automatically, or switch MODAI_BANK_QUOTE_CURRENCY if you prefer another settlement flow.',
    ...
    billingSwiftLabel: 'SWIFT',
    billingQuoteCurrencyLabel: 'Quote currency',
    billingQuoteRateLabel: 'USD/TRY rate',
  ...
  tr: {
    ...
    billingSetupHostedShort: 'Hosted',
    billingSetupBankShort: 'IBAN',
    billingSetupPartial: 'kur gerekli',
    billingSetupOptional: 'opsiyonel',
    billingSetupBankPartialHint: 'Banka alıcı bilgileri hazır. TRY invoice üretebilmek için MODAI_BANK_USD_TO_TRY_RATE ekle veya başka bir tahsilat akışı kullanacaksan MODAI_BANK_QUOTE_CURRENCY alanını buna göre değiştir.',
    ...
    billingFastAliasLabel: 'FAST / SWIFT',
    billingSwiftLabel: 'SWIFT',
    billingQuoteCurrencyLabel: 'Fiyat para birimi',
    billingQuoteRateLabel: 'USD/TRY kuru',
