...
node cli.js --version           # → 2.1.88 (modAI)
node cli.js -p "Hello modAI"    # Non-interactive mode
...
**Authentication required**: Set `ANTHROPIC_API_KEY` or run `node cli.js auth login`.
