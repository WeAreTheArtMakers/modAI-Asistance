...
const DEFAULT_PREFIX = `You are modAI, the coding assistant inside the modAI CLI.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are modAI, the coding assistant inside the modAI CLI, running within the modAI Agent SDK.`
const AGENT_SDK_PREFIX = `You are a modAI agent running within the modAI Agent SDK.`
